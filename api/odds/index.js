...
const TEAM_NAME_MAPPING = {
    ...
    'WAS': 'commanders', 'washington commanders': 'commanders', 'commanders': 'commanders',
    'NE': 'patriots', 'new england patriots': 'patriots', 'patriots': 'patriots',
    'NYJ': 'jets-nfl', 'new york jets': 'jets-nfl',
    'MIA': 'dolphins', 'miami dolphins': 'dolphins', 'dolphins': 'dolphins',
    'BUF': 'bills', 'buffalo bills': 'bills', 'bills': 'bills',
    'BAL': 'ravens', 'baltimore ravens': 'ravens', 'ravens': 'ravens',
    'PIT': 'steelers', 'pittsburgh steelers': 'steelers', 'steelers': 'steelers',
    'CLE': 'browns', 'cleveland browns': 'browns', 'browns': 'browns',
    'CIN': 'bengals', 'cincinnati bengals': 'bengals', 'bengals': 'bengals',
    'TEN': 'titans', 'tennessee titans': 'titans', 'titans': 'titans',
    'IND': 'colts', 'indianapolis colts': 'colts', 'colts': 'colts',
    'HOU': 'texans', 'houston texans': 'texans', 'texans': 'texans',
    'JAX': 'jaguars', 'jacksonville jaguars': 'jaguars', 'jaguars': 'jaguars',
    'KC': 'chiefs', 'kansas city chiefs': 'chiefs', 'chiefs': 'chiefs',
    'LAC': 'chargers', 'los angeles chargers': 'chargers', 'chargers': 'chargers',
    'LV': 'raiders', 'las vegas raiders': 'raiders', 'raiders': 'raiders',
    'DEN': 'broncos', 'denver broncos': 'broncos', 'broncos': 'broncos',
    'MIN': 'vikings', 'minnesota vikings': 'vikings', 'vikings': 'vikings',
    'GB': 'packers', 'green bay packers': 'packers', 'packers': 'packers',
    'CHI': 'bears', 'chicago bears': 'bears', 'bears': 'bears',
    'DET': 'lions', 'detroit lions': 'lions', 'lions': 'lions',
    'TB': 'buccaneers', 'tampa bay buccaneers': 'buccaneers', 'buccaneers': 'buccaneers', 'bucs': 'buccaneers',
    'NO': 'saints', 'new orleans saints': 'saints', 'saints': 'saints',
    'CAR': 'panthers-nfl', 'carolina panthers': 'panthers-nfl',
    'ATL': 'falcons', 'atlanta falcons': 'falcons', 'falcons': 'falcons',
    'SF': 'niners', 'san francisco 49ers': 'niners', '49ers': 'niners',
    'SEA': 'seahawks', 'seattle seahawks': 'seahawks', 'seahawks': 'seahawks',
    'LAR': 'rams', 'los angeles rams': 'rams', 'rams': 'rams',
    'ARI': 'cardinals', 'arizona cardinals': 'cardinals', 'cardinals': 'cardinals',

    // NBA
    'philadelphia 76ers': 'sixers', '76ers': 'sixers', 'sixers': 'sixers',
    'boston celtics': 'celtics', 'celtics': 'celtics', 'BOS': 'celtics',
    'brooklyn nets': 'nets', 'nets': 'nets', 'BKN': 'nets', 'BK': 'nets',
    'new york knicks': 'knicks', 'knicks': 'knicks', 'NYK': 'knicks', 'NY': 'knicks',
    'toronto raptors': 'raptors', 'raptors': 'raptors', 'TOR': 'raptors',
    'chicago bulls': 'bulls', 'bulls': 'bulls',
    'cleveland cavaliers': 'cavaliers', 'cavaliers': 'cavaliers', 'cavs': 'cavaliers', 'CLE': 'cavaliers',
    'detroit pistons': 'pistons', 'pistons': 'pistons',
    'indiana pacers': 'pacers', 'pacers': 'pacers', 'IND': 'pacers',
    'milwaukee bucks': 'bucks', 'bucks': 'bucks', 'MIL': 'bucks',
    'atlanta hawks': 'hawks', 'hawks': 'hawks',
    'charlotte hornets': 'hornets', 'hornets': 'hornets', 'CHA': 'hornets',
    'miami heat': 'heat', 'heat': 'heat',
    'orlando magic': 'magic', 'magic': 'magic', 'ORL': 'magic',
    'washington wizards': 'wizards', 'wizards': 'wizards', 'WAS': 'wizards',
    ...
    'portland trail blazers': 'blazers', 'trail blazers': 'blazers', 'blazers': 'blazers', 'POR': 'blazers',
    'utah jazz': 'jazz', 'jazz': 'jazz', 'UTA': 'jazz',
    'golden state warriors': 'warriors', 'warriors': 'warriors', 'GSW': 'warriors', 'GS': 'warriors',
    'los angeles clippers': 'clippers', 'clippers': 'clippers', 'LAC': 'clippers',
    'los angeles lakers': 'lakers', 'lakers': 'lakers', 'LAL': 'lakers',
    'phoenix suns': 'suns', 'suns': 'suns', 'PHX': 'suns', 'PHO': 'suns',
    'sacramento kings': 'kings-nba', 'sacramento': 'kings-nba', 'SAC': 'kings-nba',
    'dallas mavericks': 'mavericks', 'mavericks': 'mavericks', 'mavs': 'mavericks',
    'houston rockets': 'rockets', 'rockets': 'rockets',
    'memphis grizzlies': 'grizzlies', 'grizzlies': 'grizzlies', 'MEM': 'grizzlies',
    'new orleans pelicans': 'pelicans', 'pelicans': 'pelicans', 'NOP': 'pelicans',
    'san antonio spurs': 'spurs', 'spurs': 'spurs', 'SAS': 'spurs', 'SA': 'spurs',

    // MLB
    'philadelphia phillies': 'phillies', 'phillies': 'phillies',
    'new york yankees': 'yankees', 'yankees': 'yankees', 'NYY': 'yankees',
    'new york mets': 'mets', 'mets': 'mets', 'NYM': 'mets',
    ...
    'los angeles angels': 'angels', 'angels': 'angels', 'la angels': 'angels', 'LAA': 'angels',
    'oakland athletics': 'athletics', 'athletics': 'athletics', "a's": 'athletics', 'OAK': 'athletics',
    'seattle mariners': 'mariners', 'mariners': 'mariners',
    'texas rangers': 'rangers-mlb', 'rangers': 'rangers-mlb', 'TEX': 'rangers-mlb',
    'atlanta braves': 'braves', 'braves': 'braves',
    'miami marlins': 'marlins', 'marlins': 'marlins',
    'washington nationals': 'nationals', 'nationals': 'nationals', 'nats': 'nationals',
    'arizona diamondbacks': 'diamondbacks', 'diamondbacks': 'diamondbacks', 'd-backs': 'diamondbacks',
    ...
    'st. louis cardinals': 'cardinals-mlb', 'st louis cardinals': 'cardinals-mlb',
    ...
    'new york rangers': 'rangers-nhl', 'NYR': 'rangers-nhl',
    ...
    'carolina hurricanes': 'hurricanes', 'hurricanes': 'hurricanes',
    'florida panthers': 'panthers-nhl', 'FLA': 'panthers-nhl',
    'tampa bay lightning': 'lightning', 'lightning': 'lightning', 'TBL': 'lightning',
    'toronto maple leafs': 'maple leafs', 'maple leafs': 'maple leafs',
    ...
    'dallas stars': 'stars-nhl', 'DLS': 'stars-nhl',
    'minnesota wild': 'wild', 'wild': 'wild',
    'winnipeg jets': 'jets-nhl', 'WPG': 'jets-nhl',
    ...
    'los angeles kings': 'kings-nhl', 'LAK': 'kings-nhl',
    'anaheim ducks': 'ducks', 'ducks': 'ducks', 'ANA': 'ducks',
    'arizona coyotes': 'coyotes', 'coyotes': 'coyotes', 'utah hockey club': 'utah', 'utah': 'utah',
    'columbus blue jackets': 'blue jackets', 'blue jackets': 'blue jackets', 'CBJ': 'blue jackets',
    'new york islanders': 'islanders', 'islanders': 'islanders', 'NYI': 'islanders'
};

// Shop Stripe Checkout API
// POST: Create a Stripe PaymentIntent for shop purchases
    ...
    try {
        ...
        for (const item of items) {
            ...
            if (item.variantId && product.hasVariants) {
                ...
                // Check inventory for non-variant products
        ...
        const order = {
            ...
            sellerId: null, // Site shop - we are the seller
            sellerUsername: null,
            orderType: 'shop',
            items: orderItems,

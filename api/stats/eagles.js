  ...
  try {
    ...
    if (cachedStats) {
      return res.status(200).json({
        passing: cachedStats.passing,
        rushing: cachedStats.rushing,
        receiving: cachedStats.receiving,
        scoring: cachedStats.scoring,
    ...
    const staticDataPath = path.join(__dirname, '../../data/eagles-stats.json');
    ...
    console.error('Eagles stats error:', error);

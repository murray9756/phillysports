  ...
  try {
    ...
    if (cachedStats) {
      return res.status(200).json({
        homeRuns: cachedStats.homeRuns,
        hits: cachedStats.hits,
        rbis: cachedStats.rbis,
        battingAverage: cachedStats.battingAverage,
        runs: cachedStats.runs,
        stolenBases: cachedStats.stolenBases,
    ...
    const staticDataPath = path.join(__dirname, '../../data/phillies-stats.json');
    ...
    console.error('Phillies stats error:', error);

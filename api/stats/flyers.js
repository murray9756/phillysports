  ...
  try {
    ...
    if (cachedStats) {
      return res.status(200).json({
        goals: cachedStats.goals,
        assists: cachedStats.assists,
        points: cachedStats.points,
        games: cachedStats.games,
        penaltyMinutes: cachedStats.penaltyMinutes,
        plusMinus: cachedStats.plusMinus,
        goalieWins: cachedStats.goalieWins,
        shutouts: cachedStats.shutouts,
    ...
    const staticDataPath = path.join(__dirname, '../../data/flyers-stats.json');
    ...
    console.error('Flyers stats error:', error);

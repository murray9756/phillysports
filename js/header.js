        ...
        <header class="header">
            <div class="header-top">
                ...
                <a href="/" class="header-logo">
                    ...
                    <div class="logo-for-light" style="position: relative; width: 100%; max-width: 380px; height: 220px; background: linear-gradient(180deg, #1A2744 0%, #0d1520 100%); border: 8px solid #F5F0E1; overflow: hidden; margin: 0 auto;">
                    ...
                    <div class="logo-for-dark" style="position: relative; width: 100%; max-width: 380px; height: 220px; background: linear-gradient(180deg, #F5F0E1 0%, #e8e0cc 100%); border: 8px solid #1A2744; overflow: hidden; margin: 0 auto;">
                        <div style="position: absolute; top: 8px; left: 8px; right: 8px; bottom: 8px; border: 3px solid #8B1A28; pointer-events: none; z-index: 10;"></div>

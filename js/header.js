        ...
        <header class="header">
            <div class="header-top">
                ...
                <a href="/" class="header-logo">
                    ...
                    <div class="logo-light" style="position: relative; width: 100%; max-width: 480px; height: 280px; background: linear-gradient(180deg, #F5F0E1 0%, #e8e0cc 100%); border: 8px solid #1A2744; overflow: hidden; margin: 0 auto;">
                        ...
                        <div style="position: absolute; top: 12px; width: 100%; display: flex; justify-content: center; align-items: center; gap: 12px; z-index: 5;">
                            <svg style="width: 22px; height: 22px; filter: drop-shadow(2px 2px 3px rgba(0,0,0,0.4));" viewBox="0 0 40 40">
                                <defs><linearGradient id="redStarLight" x1="0%" y1="0%" x2="100%" y2="100%"><stop offset="0%" style="stop-color:#c42030"/><stop offset="50%" style="stop-color:#8B1A28"/><stop offset="100%" style="stop-color:#5a0f15"/></linearGradient></defs>
                                <polygon points="20,2 24,14 37,14 27,22 31,35 20,27 9,35 13,22 3,14 16,14" fill="url(#redStarLight)"/>
                            </svg>
                            <span style="font-family: 'Brush Script MT', cursive; font-size: 16px; color: #1A2744; letter-spacing: 4px;">Est. 2026</span>
                            <svg style="width: 22px; height: 22px; filter: drop-shadow(2px 2px 3px rgba(0,0,0,0.4));" viewBox="0 0 40 40">
                                <defs><linearGradient id="blueStarLight" x1="0%" y1="0%" x2="100%" y2="100%"><stop offset="0%" style="stop-color:#3a5a8c"/><stop offset="50%" style="stop-color:#1A2744"/><stop offset="100%" style="stop-color:#0d1520"/></linearGradient></defs>
                                <polygon points="20,2 24,14 37,14 27,22 31,35 20,27 9,35 13,22 3,14 16,14" fill="url(#blueStarLight)"/>
                            </svg>
                        </div>
                    ...
                    <!-- Dark Mode Logo (F2) -->
                    <div class="logo-dark" style="display: none; position: relative; width: 100%; max-width: 480px; height: 280px; background: linear-gradient(180deg, #1A2744 0%, #0d1520 100%); border: 8px solid #F5F0E1; overflow: hidden; margin: 0 auto;">
                        <div style="position: absolute; top: 8px; left: 8px; right: 8px; bottom: 8px; border: 3px solid #8B1A28; pointer-events: none; z-index: 10;"></div>
                        ...
                        <div style="position: absolute; top: 12px; width: 100%; display: flex; justify-content: center; align-items: center; gap: 12px; z-index: 5;">
                            <svg style="width: 22px; height: 22px; filter: drop-shadow(2px 2px 3px rgba(0,0,0,0.6));" viewBox="0 0 40 40">
                                <defs><linearGradient id="redStarDark" x1="0%" y1="0%" x2="100%" y2="100%"><stop offset="0%" style="stop-color:#c42030"/><stop offset="50%" style="stop-color:#8B1A28"/><stop offset="100%" style="stop-color:#5a0f15"/></linearGradient></defs>
                                <polygon points="20,2 24,14 37,14 27,22 31,35 20,27 9,35 13,22 3,14 16,14" fill="url(#redStarDark)"/>
                            </svg>
                            <span style="font-family: 'Brush Script MT', cursive; font-size: 16px; color: #F5F0E1; letter-spacing: 4px;">Est. 2026</span>
                            <svg style="width: 22px; height: 22px; filter: drop-shadow(2px 2px 3px rgba(0,0,0,0.6));" viewBox="0 0 40 40">
                                <defs><linearGradient id="blueStarDark" x1="0%" y1="0%" x2="100%" y2="100%"><stop offset="0%" style="stop-color:#6a8fc4"/><stop offset="50%" style="stop-color:#4a6fa0"/><stop offset="100%" style="stop-color:#3a5a8c"/></linearGradient></defs>
                                <polygon points="20,2 24,14 37,14 27,22 31,35 20,27 9,35 13,22 3,14 16,14" fill="url(#blueStarDark)"/>
                            </svg>
                        </div>
                        <div style="position: absolute; top: 90px; right: 25px; text-align: right; z-index: 5;">
